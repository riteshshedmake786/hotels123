        ...
        <div class="d-flex flex-wrap justify-content-between mt-1">
          <div class="d-flex flex-column flex-grow-1 pr-8">
            <div class="d-flex flex-wrap mb-4"> <a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2"><i class="flaticon2-new-email mr-2 font-size-lg"></i>admin@std.com</a> 
              <a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2"><i class="flaticon2-calendar-3 mr-2 font-size-lg"></i><?php echo $hotelsData->country?></a> 
  ...
  <div class="card-body">
    ...
    <div class="example">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="HotelIncludes"  href="{{url('admin/hotel/hotelView/'.$hotelsData->id)}}"> <span class="nav-icon"><i class="fas fa-house-user"></i></span> <span class="nav-text"> List</span> </a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content mt-5" id="myTabContent">
        <div class="tab-pane fade show active" id="HotelIncludesList" role="tabpanel" aria-labelledby="HotelIncludes">
          <div class="card card-custom gutter-b" style="box-shadow: none;">
            <div class="card-header flex-wrap py-3">
              <div class="card-title">
                ...
                <a href="{{ url('/admin/hotel/add_hotels_includes/'.$hotelsData->id)}}" class="btn btn-primary font-weight-bolder" style="height: 37px;">
                ...
                <table class="table table-bordered table-checkable" id="hotelList">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('/admin/hotel/get_single_hotels_includes/')}}/{{$data->id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="View details">            
                         <button  class="btn btn-primary btn-sm">View</button>
                       </a>
                       <a href="{{ url('admin/hotel/edit_hotel_include')}}/{{$data->id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="View details">
