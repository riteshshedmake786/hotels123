   ...
   <div class="row">
      <div class="col-lg-12">
         ...
         <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form  action="{{url('admin/hotel/submit_hotels_include')}}" class="form" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
               ...
               <div class="card-body">
                  <div class="form-group row">
                     <div class="col-lg-6">
                        ...
                        <input type="text" name="hotel_title" class="form-control" placeholder="Enter Venue name" value="{{ old('hotel_title') }}">
                     ...
                     <div class="col-lg-6">
                        ...
                        <input type="text" name="sub_title" class="form-control" placeholder="Enter Venue Sub Title" value="{{ old('sub_title') }}">
                  ...
                  <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <select id="type" class="form-control" name="event_type" required="">
                           <option value="">Select</option>
                    ...
                    <div class="form-group row">
                      <div class="col-lg-6">
                        ...
                        <div class="custom-file">
                           ...
                           <label class="custom-file-label" for="featured_img" value="" style="overflow: hidden;">Choose file</label>
                        </div>
                     </div>
                     <div class="col-lg-6">
