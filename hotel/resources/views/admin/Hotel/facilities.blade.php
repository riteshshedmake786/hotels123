            ...
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" method="post" action="{{ url('admin/facilities/add') }}" id="form1"
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            <div class="card-title">
                                <h3 class="card-label">Facility List</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <!--begin: Datatable-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2"
                                               title="Edit details" onclick="editFacility({{$eAtt->id}})">
...
@section('pageScript')
    <script type="text/javascript">
        ...
        function editFacility($id) {
            ...
            $.get("/admin/facilities/edit/" + $id, function (data, status) {
                ...
                $('#capId').val(data.id);
                $('#form-heading').text('Edit Facility');
                $('.btn-primary').text('Update');
                $('#form1').attr('action', '{{ url("/admin/facilities/update") }}');
            });
        }
    </script>
@endsection
