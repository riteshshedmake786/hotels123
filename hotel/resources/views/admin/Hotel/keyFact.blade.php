  ...
  <div class="card-body">
    ...
    <div class="example">
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link active" id="KeyFact"  href="{{url('admin/hotel/keyFact/'.$hotelsData->id)}}" aria-controls="profile"> <span class="nav-icon"><i class="fas fa-key"></i></span> <span class="nav-text">Key Facts</span> </a>
        </li>
        <li class="nav-item">
        ...
        <div class="card card-custom gutter-b" style="box-shadow: none;">
          <div class="card-header flex-wrap py-3">
            <div class="card-title">
              ...
              <a href="#" class="btn btn-primary font-weight-bolder" style=" height: 37px;" data-toggle="modal" data-target="#addKeyFactModal">
                <span class="fas fa-plus-circle"></span>&nbsp;Add Key Fact
              </a>
...
<!-- Add Modal -->
<div class="modal fade" id="addKeyFactModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Key Fact Form</h5>
     ...
     <div class="modal-body">
       ...
       <form action="{{url('admin/hotel/submitKeyFact')}}" method="post">
        {{ csrf_field() }}
...
<div class="modal fade" id="kfEditModal" tabindex="-1" role="dialog" data-backdrop="static"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Key Fact Form</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <i aria-hidden="true" class="ki ki-close"></i>
                 </button>
            </div>
...
if(counter >= 0){
  ...
  function editKeyFact($hotel_id, $id){
    ...
    console.log(id);
    $.post("edit_kf", {hotel_id: hotel_id, id: id , _token: '{!! csrf_token() !!}'})
    .done(function( data ) {
        if(data.html != '') {
...
$(document).on('click', '#saveEdit', function(){
  ...
  if (key_attribute_id == "") {
   ...
   /*var values = $('#kfEditModal .form-control').serializeArray();
   if (values) {
    console.log('hi1'+values);
    obj = {};
    jQuery.each(values, function () {
      obj[this.name] = this.value;
      console.log('hi2'+this.value);
    });
  }
      console.log('check value'+obj);*/
        //swal.fire('Do you want to close it without save?', '완료!', 'error');
        
        $.post( "save_edit_kf_modal", { id: id, hotel_id: hotel_id, key_attribute_id:key_attribute_id, description: description, _token: '{!! csrf_token() !!}' })
        .done(function( data ) {
