    ...
    <div class="d-flex align-items-center flex-wrap mr-1">
      ...
      <div class="d-flex flex-column">
        ...
        <div class="d-flex align-items-center font-weight-bold my-2">
          ...
          Merchant</a>
          <!--end::Item-->
          <!--begin::Item--> <span class="label label-dot label-sm bg-dark opacity-75 mx-3"></span> <a href="{{ url('admin/merchantList') }}" class="text-dark text-hover-dark opacity-75 hover-opacity-100">
          Merchant List</a>
...
<div class=" container ">
  ...
  <div class="card card-custom gutter-b">
    <div class="card-body">
          ...
          <div class="d-flex flex-wrap justify-content-between mt-1">
            <div class="d-flex flex-column flex-grow-1 pr-8">
              <div class="d-flex flex-wrap mb-4">
                <a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2"><i class="flaticon2-new-email mr-2 font-size-lg"></i>{{$merchant['email']}}</a>
                <a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2"><i class="flaticon2-calendar-3 mr-2 font-size-lg"></i>{{$merchant['location']}}</a>
              </div>
            </div>
          </div>
          <!--end::Content-->
      ...
      <div class="d-flex flex-column text-dark-75"> <span class="font-weight-bolder font-size-sm">Total Hotel</span> <span class="font-weight-bolder font-size-h5"><span class="text-dark-50 font-weight-bold"></span>164,700</span>
      </div>
    </div>
    <!--end::Item-->
    <!--begin::Item-->
...
<td>
  @if($hld->is_featured==1)
  <span class="label label-lg font-weight-boldlabel-light-success label-inline">Yes</span>
  @endif
  @if($hld->is_featured==0)
  <span class="label label-lg font-weight-boldlabel-light-success label-inline">No</span>
  @endif
</td>
<td>
  @if($hld->status=='ACTIVE')
  <span class="label label-lg font-weight-boldlabel-light-success label-inline">{{$hld->status}}</span>
  @endif
