      ...
      <div class="col-xl-3">
         ...
         <div class="card card-custom bg-light-danger card-stretch gutter-b">
            ...
            <div class="card-body">
               ...
               <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{ $merchantCount ?? 0 }}</span>
               <span class="font-weight-bold text-muted font-size-sm">Total Merchant</span>
            </div>
            <!--end::Body-->
         </div>
         <!--end::Stats Widget 26-->
      ...
      <div class="col-xl-3">
         ...
         <div class="card card-custom bg-light-info card-stretch gutter-b">
            ...
            <div class="card-body">
               ...
               <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{ $supplierCount ?? 0 }}</span>
