...
<div class="login-form login-signup m-auto">
    <!--begin::Form-->
    <form class="form" novalidate="novalidate" role="form" method="POST" action="{{ url('/supplier/register') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
        <!--begin::Title-->
        ...
        <div class="form-group">
            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="Company Name" name="company_name" value="{{ old('company_name') }}"  autocomplete="off"/>
        ...
        <!--begin::Form group-->
        <div class="form-group">
            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="file" name="image" autocomplete="off" value="{{old('image')}}" />
            @if ($errors->has('image'))
                    <span class="help-block">
        ...
        <div class="form-group" style="padding-top: 10px;">
            <label class="checkbox mb-0">
                <input type="checkbox" id="checkbox" name="terms" value="true" style="margin-right: 10px;"/>
                <span></span>&nbsp;&nbsp;&nbsp;
        ...
        <div class="form-group d-flex flex-wrap pb-lg-0 pb-3">
            ...
            <a href="{{ url('/supplier/login') }}" id="kt_login_signup_cancel" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel</a>
        </div>
        <!--end::Form group-->
    </form>
    <!--end::Form-->
