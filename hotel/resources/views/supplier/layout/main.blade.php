...
<head><base href="">
 <meta charset="utf-8"/>
 <title>HotelsVenue | Supplier</title>
      ...
      <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
       ...
       <ul class="menu-nav ">
               <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                  <a  href="{{url('supplier/home')}}" class="menu-link ">
               ...
               <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                  <a  href="{{ url('supplier/hotelSupplierList')}}" class="menu-link ">
                     <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                           <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                     ...
                     <span class="menu-text">Supplier Profile</span>
                  </a>
               </li>
               <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                  <a  href="{{ url('supplier/addnewSupplierProducts')}}" class="menu-link ">
                     <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                           <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                     ...
                     <span class="menu-text">Add Supplier Product</span>
                  </a>
               </li>
               <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                  <a  href="{{ url('supplier/supplierProductList')}}" class="menu-link ">
                     <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                           <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                     ...
                     <span class="menu-text">Supplier Product List</span>
                  </a>
               </li>
            </ul>
      </div>
        ...
        <div class="topbar">
         <div class="topbar-item">
                       ...
                       <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                        ...
                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ Auth::guard('supplier')->user()->company_name }}</span>
                        <span class="symbol symbol-lg-35 symbol-25 symbol-light-success"> 
                        </span>
                       </div>
                       <a href="{{ url('/supplier/logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5"
                      ...
                      <a href="#" class="navi-item">
                       <span class="navi-link p-0 pb-2">
                        <span class="navi-icon mr-1">
                         ...
                         <span class="navi-text text-muted text-hover-primary">{{ Auth::guard('supplier')->user()->email }}</span>
                        </span>
                       </a>
          ...
          <a href="/metronic/demo1/custom/apps/user/profile-3.html" class="navi-item">
            <div class="navi-link">
              ...
              <div class="navi-text">
                ...
                <div class="text-muted">{{ Auth::guard('supplier')->user()->email }}</div>
              </div>
            </div>
          </a>
          <a href="/metronic/demo1/custom/apps/user/profile-2.html" class="navi-item">
            <div class="navi-link">
              ...
              <div class="navi-text">
                ...
                <div class="text-muted">{{ Auth::guard('supplier')->user()->supplier_password }}</div>
              </div>
            </div>
          </a>
        </div>
