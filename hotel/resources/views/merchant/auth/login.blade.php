					...
					<div class="login-form login-signin col-md-10">
                        ...
                        {{ csrf_field() }}
							...
							<div class="pb-13 pt-lg-0 pt-5">
								<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome Hotel</h3> <span class="text-muted font-weight-bold font-size-h4">New Here?
                                    <a href="{{ url('/merchant/register') }}" id="kt_login_signup" class="text-primary font-weight-bolder">Create an Account</a></span> </div>
							<!--begin::Title-->
							<!--begin::Form group-->
