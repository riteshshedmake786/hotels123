...
<div class="subheader py-2  subheader-transparent " id="kt_subheader">
  <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    <!--begin::Info-->
    <div class="d-flex align-items-center flex-wrap mr-1" style="margin-left: -560px;">
      <!--begin::Heading-->
...
<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
  ...
  <div class="d-flex flex-column flex-lg-fill">
    <span class="text-dark-75 font-weight-bolder font-size-sm">capacity</span>
    <span class="font-weight-bolder font-size-h5">
      <span class="text-dark-50 font-weight-bold"></span>{{$hotelsData->capacity}}</span>
  </div>
</div>
<!--end::Item-->
</div>
  ...
  <div class="card-body">
    ...
    <div class="example">
      <ul class="nav nav-tabs" id="myTab" role="tablist">
       <!--  <li class="nav-item">
          <a class="nav-link" id="HotelIncludes"  href="{{url('merchant/hotel/hotelMerchantView/'.$hotelsData->id)}}"> <span class="nav-icon"><i class="fas fa-house-user"></i></span> <span class="nav-text">Hotel VenueList</span> </a>
        </li> -->
        <li class="nav-item">
          <a class="nav-link " id="KeyFact"  href="{{url('merchant/hotel/hotelMerchantView/'.$hotelsData->id)}}" aria-controls="profile"> <span class="nav-icon"><i class="fas fa-key"></i></span> <span class="nav-text">Key Facts</span> </a>
        </li>
        <!-- <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" id="featured"  href="{{url('merchant/hotel/featuredMerchant/'.$hotelsData->id)}}" aria-controls="profile"> <span class="nav-icon"><i class="flaticon2-layers-1"></i></span> <span class="nav-text">Hotel Featured</span> </a>
        </li>
      </ul>
      <div class="tab-content mt-5" id="myTabContent">
        <div class="card card-custom gutter-b" style="box-shadow: none;">
          <div class="card-header flex-wrap py-3">
            ...
            <div class="card-body">
              <form class="form" action="{{url('merchant/hotel/submitfeaturedMerchant')}}" method="post">
              {{ csrf_field() }}
              <div class="form-group row">
                <div class="col-md-12 col-form-label" style="display: contents;">
