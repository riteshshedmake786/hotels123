    ...
    <div class="d-flex align-items-center flex-wrap mr-1">
      ...
      <div class="d-flex flex-column">
        ...
        <div class="d-flex align-items-center font-weight-bold my-2">
          ...
          Hotel List</a>
          <span class="label label-dot label-sm bg-dark opacity-75 mx-3"></span> <a href="{{ url('merchant/hotelMerchantListView') }}" class="text-dark text-hover-dark opacity-75 hover-opacity-100">
          Hotel View</a>
      ...
      <div class="example">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
         <!--  <li class="nav-item">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link active" id="Capacity"  href="{{url('merchant/hotel/capacityMerchant/'.$hotelsData->id)}}" aria-controls="profile"> <span class="nav-icon"><i class="flaticon2-layers-1"></i></span> <span class="nav-text"> Hotel Capacity</span> </a>
          </li> -->
          <li class="nav-item">
        ...
        <div class="tab-content mt-5" id="myTabContent"> 
              ...
              <div class="card-header flex-wrap py-3">
                <div class="card-title">
                 ...
                 <a href="#" class="btn btn-primary font-weight-bolder" style=" height: 37px;" data-toggle="modal" data-target="#addCapacityMerchantModal">
                ...
                <table class="table table-bordered table-checkable" id="hotelKeyList">
                  ...
                  <tbody>@php
                    ...
                    <tr>
                      ...
                      <!-- <td><span class="label label-lg font-weight-bold label-light-primary label-inline">Admin</span></td> -->
                      <td>
...
<!-- Add Modal -->
<div class="modal fade" id="addCapacityMerchantModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
       ...
       <form action="{{url('merchant/hotel/submitcapacityMerchant')}}" method="post">
        {{ csrf_field() }}
...
if(counter >= 0){
  ...
  function editCapacity($hotel_id, $id){
    ...
    console.log(id);
    $.post("edit_capacity_merchant", {hotel_id: hotel_id, id: id , _token: '{!! csrf_token() !!}'})
    .done(function( data ) {
        if(data.html != '') {
...
$(document).on('click', '#saveEdit', function(){
  ...
  if (capacity_attribute_id == "") {
    ...
    swal.fire('Please enter the capacity', 'Required error', 'error');
        ...
        $.post( "save_edit_capacity_merchant", { id: id, hotel_id: hotel_id, capacity_attribute_id:capacity_attribute_id, capacity_value: capacity_value, _token: '{!! csrf_token() !!}' })
        .done(function( data ) {
