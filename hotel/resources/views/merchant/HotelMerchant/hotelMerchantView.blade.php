...
<div class="subheader py-2  subheader-transparent " id="kt_subheader">
  <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    <!--begin::Info-->
    <div class="d-flex align-items-center flex-wrap mr-1" style="margin-left: -632px;">
      <!--begin::Heading-->
      <div class="d-flex flex-column">
        ...
        <div class="d-flex align-items-center font-weight-bold my-2">
          ...
          Hotel Details                            </a>
          <!--end::Item-->
          <!--begin::Item--> <span class="label label-dot label-sm bg-dark opacity-75 mx-3"></span> <a href="{{ url('merchant/hotelMerchantList') }}" class="text-dark text-hover-dark opacity-75 hover-opacity-100">
          Hotel List</a>
  ...
  <div class="card-body">
    ...
    <div class="example">
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item ">
          <a class="nav-link active" id="KeyFact"  href="{{url('merchant/hotel/hotelMerchantView/'.$hotelsData->id)}}" aria-controls="profile"> <span class="nav-icon"><i class="fas fa-key"></i></span> <span class="nav-text">Key Facts</span> </a>
        </li>
        <!-- <li class="nav-item">
  ...
  $(document).ready(function(){
    $('#addSocial').on('click',function(){
      ...
      if(counter < 5){
        ...
        $('#social_input').append('<div class="row div_f_'+f+'" data-id="'+f+'">'
                        +'<div class="form-group validated col-md-5">'
