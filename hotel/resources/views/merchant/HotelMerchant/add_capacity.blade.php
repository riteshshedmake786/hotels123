        ...
        <div class="col-lg-12">
            <div class="card card-custom gutter-b">
                ...
                <!-- <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="Capacity" href="" aria-controls="profile"> <span
                                        class="nav-icon"><i class="flaticon2-layers-1"></i></span>
                                    <span class="nav-text">Capacity</span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="Menu" href="" aria-controls="profile"> <span class="nav-icon"><i
                                            class="flaticon2-layers-1"></i></span> <span class="nav-text">Menu</span>
                                </a>
                            </li>
                        </ul> -->
...
{{--                                value="Capacity" id="capacity" onclick="onCheck(value)">--}}
{{--                                <span class="fas fa-plus-circle"></span> &nbsp;Add Venue Capacity--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                        <div class="card-body">--}}
{{--                            <!--begin: Datatable-->--}}
...
{{--                                                src="{{ asset('storage/capacityAttributeImg/'.$list->capacity_image)}}"--}}
...
{{--                                                title="View details" onclick="editCapacity({{$list->id}} )">--}}
{{--                                                <button class="btn btn-warning btn-sm"--}}
{{--                                                    style=" margin-left: 13px;">Edit</button>--}}
{{--                                            </a>--}}
{{--                                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2"--}}
{{--                                                title="View details" onclick="deleteCapacity({{$list->id}})">--}}
{{--                                                <button class="btn btn-danger btn-sm"--}}
{{--                                                    style=" margin-left: 38px;">Delete</button>--}}
{{--                                            </a>--}}
{{--                                        </td>--}}
{{--                                    </tr>--}}
{{--                                    @endforeach--}}
...
{{--                        <!--begin::Card-->--}}
{{--                        <div class="card card-custom gutter-b example example-compact" id="capacity_form"--}}
{{--                            style="display:none;">--}}
...
{{--                                        <label class="form-control-label" for="capacity_attribute_id">Venue capacity</label>--}}
{{--                                        <select id="capacity_attribute_id" class="form-control"--}}
{{--                                            name="capacity_attribute_id[]" required="">--}}
...
{{--                                        <button type="button" class="btn btn-outline-success btn-icon btn-circle"--}}
{{--                                            data-count="0" id="addSocial"><i class="flaticon2-plus"></i></button>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                        <a href="#" class="btn btn-primary font-weight-bolder" style=" height: 37px;" value="Menu"--}}
{{--                            id="menu" onclick="onCheck(value)">--}}
...
{{--                                            data-toggle="modal" data-target="#hotelImage_{{$menuItem->id}}">PDF</button>--}}
...
{{--                                    </td>--}}
{{--                                    <td>--}}
{{--                                        <a href="javascript:void(0);" class="btn btn-sm btn-clean btn-icon mr-2"--}}
{{--                                            title="View details" onclick="editMenu({{$menuItem->id}})">--}}
{{--                                            <button href="#" class="btn btn-warning btn-sm"--}}
{{--                                                style=" margin-left: 13px;">Edit</button>--}}
{{--                                        </a>--}}
{{--                                        <a href="javascript:void(0);" class="btn btn-sm btn-clean btn-icon mr-2"--}}
{{--                                            title="View details" onclick="deleteMenu({{$menuItem->id}})">--}}
...
{{--                        <!--end: Datatable-->--}}
                        ...
                        <div class="card card-custom gutter-b example example-compact" id="menu_form">
                            <div class="card card-custom gutter-b">
                                <form action="{{url('merchant/hotel/submitIncludeMenuMerchant')}}" runat="server" method="post"
                                    ...
                                    <div class="bg-warning-o-100 card-header">
                                        ...
                                        <input type="text" placeholder="Enter Menu Category Title" class="col-sm-6 form-check-inline form-control pl-3" id="category_title" name="category_title" autocomplete="off">
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group validated col-md-4">
                                                <input type="text" placeholder="Enter Menu Title 1" class="form-control" id="menu_title" name="title[]" style="margin-top: 8px;">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6" id="website_inputmenu">
                                                <label for="exampleTextarea">Menu 1 Cover Image</label>
                                                <input type="file" name="image[]" id="profile_image" onchange="loadPreview(this);" class="form-control" accept="image/*">
                                            </div>
                                            <div class="form-group col-md-5" id="website_inputmenu">
                                                <label for="exampleTextarea">Menu 1 PDF</label>
                                                <input type="file" class="form-control" id="exampleTextarea" name="doc_file[]" accept=".pdf">
                                            </div>

                                            <div class="form-group validated col-md-7">
                                                <label class="form-control-label" for="menu_cost"><span class="font-weight-boldest">Original Cost (Per Person) </span><span class="small">(All prices are inclusive of municipality fee, service charge and 5% VAT)</span></label>
                                                <input onkeypress="return isNumberKey(event)" type="text" placeholder="Enter cost" class="form-control col-sm-3" id="menu_cost_0" name="cost[]">
                                            </div>
                                            <div class="form-group validated col-md-5">
                                                <label class="form-control-label" for="discount_percentage">Special Discount for hotels venues minimum starts from 15%</label>
{{--                                                <input type="text" name="discount_cost" class="form-control" value="30">--}}
                                                <select name="discount[]" class="form-control col-sm-5" onchange="calculateprice(this, 0)">
                                            ...
                                            <div class="form-group validated col-md-3">
                                                <label class="form-control-label" for="menu_discount">Discounted Price (Per Person): </label>
                                                <input disabled type="text" class="form-control" value="" id="menu_discount_0" name="discounted_price">
                                            </div>
                                            <div id="show_discount_0" style="display: none;">
                                                ...
                                                <div class="form-group validated">
                                                    ...
                                                    <input disabled type="text" class="form-control" value="" id="customer_discount_0" name="customer_discount">
                                                </div>
                                            </div>
                                            <div class="form-group ml-auto">
                                                <button type="button" class="btn btn-outline-success" data-count="0" id="addSocialmenu">
                                                    <i class="flaticon2-plus"></i> Add New Menu</button>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12 text-center">
                                                <div class="btn btn-outline-dark w-25" onclick="openPreview()">Preview</div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-dialog width-400px sign-in-modal" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <img id="preview_img" src="https://w3adda.com/wp-content/uploads/2019/09/No_Image-128.png" class="w-100"/>
                                    </div>
                                </div>
                            </div>
                        </div>
