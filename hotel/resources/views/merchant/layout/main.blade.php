         ...
         <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto"  id="kt_aside">
               ...
               <div class="brand flex-column-auto " id="kt_brand">
                  <!--begin::Logo-->
                  <a href="{{url('/')}}" class="brand-logo" style="width: 100%;">
                  <img alt="Logo" src="{{asset('front_assets/wp-content/uploads/sites/4/2017/10/hotelvenueslogo.png')}}" style="height: 95px;" />
                  </a>
                  <!--end::Logo-->
                  <!--begin::Toggle-->
                     ...
                     <ul class="menu-nav ">
                        ...
                        <li class="menu-item  menu-item-submenu" aria-haspopup="true"  data-menu-toggle="hover">
                           <a  href="{{ url('/merchant/hotel/hotelMerchantVenue')}}" class="menu-link menu-toggle">
                              ...
                              <span class="menu-text">Venue and Menu List</span>
                           </a>

                        </li>
                         <li class="menu-item" aria-haspopup="true" >
                             <a  href="{{url('/merchant/hotel/bookingCalendar')}}" class="menu-link ">
                              <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-03-183419/theme/html/demo1/dist/../src/media/svg/icons/Communication/Dial-numbers.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                     ...
                     <div class="topbar">
                        ...
                        <div class="topbar-item">
                           <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                              ...
                              <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ Auth::guard('merchant')->user()->company_name }}</span>
