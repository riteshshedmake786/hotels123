<footer class='main_footer fadeOnLoad clearfix' style=" background-color :#1f1f1f;" id='footer'>
         <div class='top_footer column_4 align-left'>
            <div class='container'>
               <div class='row' style="padding-top:60px;padding-bottom:30px;">
                  <div class='span3'>
                     <div id="custom_html-5" class="widget_text widget gt3_widget widget_custom_html">
                        <div class="textwidget custom-html-widget"><img class="alignnone" src="{{asset('front_assets/wp-content/uploads/sites/4/2017/10/hotelvenueslogo.png')}}" alt="" width="100" height="12" /></div>
                     </div>
                     <div id="text-7" class="">
                        <div class="textwidget">
                           <p>Hotels venues is one of best company in dubai.</p>
                           <h3 class="widget-title">Our Location</h3>
                           <div class="textwidget">
                              <p>Silver Tower,Business Bay <br />
                              Dubai, UAE .</p>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class='span3'>
                     <div id="text-4" class="widget gt3_widget widget_text">
                        ...
                        <P><a href="{{asset('merchant/register')}}">Merchant Register</a></P>
                        <P><a href="{{asset('supplier/register')}}">Supplier Register</a></P>
                     </div>
                  </div>
                  <div class='span3'>
                     <div id="text-5 text-white" class="widget gt3_widget widget_text">
                  ...
                  <div class='span3'>
                     <div id="text-6 text-white" class="widget gt3_widget widget_text">
                        <h3 class="widget-title">Contact Us</h3>
                        <div class="textwidget">
                           <p>Mobile: +971 507972887<br />   
                              Office: +971 44356739
                           </p>
                        </div>
                     </div>
            ...
            <div class='container'>
               <div class='row' style="padding-top:14px;padding-bottom:14px;">
                  <div class='span4 align-left'>
                     <div id="text-10" class="widget gt3_widget widget_text">
                        <div class="textwidget">
                           <p>© 2021 Hotelsvenues. ALL RIGHTS RESERVED</p>
                        </div>
                     </div>
                  </div>
                  <div class='span4 align-center'>
                     <div id="custom_html-3" class="widget_text widget gt3_widget widget_custom_html">
                        <div class="textwidget custom-html-widget"><a href="#"><i class="fa fa-facebook" style="padding-right:18px;font-size: 17px;"></i></a>
                  ...
                  <div class='span4 align-right'>
                     <div id="custom_html-4" class="widget_text widget gt3_widget widget_custom_html">
                        <div class="textwidget custom-html-widget">
                           <p class=""><a href="#">PRIVACY POLICY</a><span style="padding: 0 8px;">|</span><a href="#">TERM OF USE</a></p>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <div class="gt3_tools_bar" style="display:none;">
         <div class="gt3_tools_bar__icon_container">
            <div class="gt3_tools_bar_icon gt3_tools_bar_icon_side_bar">
            ...
            <div class="gt3_tools_bar_icon gt3_tools_bar_icon_sale">
               <a href="https://1.envato.market/zNxO" target="_blank">
                  <div class="gt3_tools_bar__icon_src">
            ...
            <div class="gt3_tools_bar_icon gt3_tools_bar_icon_support">
               <a href="https://gt3.zendesk.com/" target="_blank">
                  <div class="gt3_tools_bar__icon_src">
                     <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <div class="gt3_tools_bar_icon gt3_tools_bar_icon_docs">
               <a href="https://livewp.site/docs/listingeasy-listing-directory-wordpress-theme/" target="_blank">
                  <div class="gt3_tools_bar__icon_src">
                     <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        width="41.169px" height="41.169px" viewBox="0 0 41.169 41.169" style="enable-background:new 0 0 41.169 41.169;"
                        xml:space="preserve">
                        <g>
                           <g>
         ...
         <div class="gt3_tools_bar__sidebar">
            ...
            <div class="gt3_tools_bar__sidebar_container">
               <div class="gt3_toolbar_button__container"><a href="https://1.envato.market/zNxO" class="gt3_toolbar_button" target="_blank">Purchase Theme Now</a></div>
      ...
      <script>
         jQuery(document).ready(function ($) {
            ...
            jQuery('.gt3_tools_bar_icon_side_bar,.gt3_tools_bar_sidebar-cover').on('click', toolbar_handler);
      ...
      <style>
         ...
         .gt3_tools_bar_icon.gt3_tools_bar_icon_sale{
         background: #f73859;
         }
         .gt3_tools_bar_icon.gt3_tools_bar_icon_side_bar{
         background: #384259;
         }
         .gt3_tools_bar_icon.gt3_tools_bar_icon_support{
         background-color: #7ac7c4;
         }
         .gt3_tools_bar_icon.gt3_tools_bar_icon_docs{
         background: #c4edde;
         }
         .gt3_tools_bar__icon a{
         color: inherit;
         }
         .gt3_tools_bar_icon div.gt3_tools_bar_icon_src{
         display: inline-block;
         width: 45px;
         height: 45px;
         line-height: 55px;
         ...
         .gt3_tools_bar_icon div.gt3_tools_bar_icon_src svg{
         width: 1em;
         height: 1em;
         display: inline-block;
         font-size: 21px;
         ...
         .gt3_tools_bar_icon.gt3_tools_baricon_side_bar div.gt3_tools_bar_icon_src{
         background-position: 28px -36px;
         }
         .gt3_tools_bar_icon.gt3_tools_baricon_sale div.gt3_tools_bar_icon_src{
         background-position: -37px -4px;
         }
         .gt3_tools_bar_icon.gt3_tools_baricon_support div.gt3_tools_bar_icon_src{
         background-position: -68px -4px;
         }
         .gt3_tools_bar_icon.gt3_tools_baricon_docs div.gt3_tools_bar_icon_src{
         ...
         .gt3_tools_bar_icon:hover .gt3_tools_bar_icon_tooltip{
         visibility: visible;
         opacity: 1;
         right: 110%;
         }
      ...
      <div id="lwa-modal-holder">
         <div class="lwa lwa-template-modal">
            <div class="lwa-modal" style="display:none;top: 200px;">
               <form name="lwa-form" class="lwa-form  lwa-login  js-lwa-login  form-visible" action="https://livewp.site/wp/md/listingeasy/wp-login.php" method="post">
                  ...
                  <p class="lwa-meta  row">
                     ...
                     <a class="lwa-show-remember-pass  lwa-action-link  js-lwa-open-remember-form" href="wp-loginc2b6.html?action=lostpassword" title="Password Lost and Found">Lost your password?</a>
                     </span>
                  </p>
               ...
               <form name="lwa-remember" class="lwa-remember  lwa-form  js-lwa-remember" action="https://livewp.site/wp/md/listingeasy/wp-login.php?action=lostpassword" method="post" style="display:none;">
      ...
      <!-- <script type='text/javascript' src="{{asset('front_assets/wp-content/plugins/contact-form-7/includes/js/scripts9dff.js?ver=5.3.2')}}" id='contact-form-7-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-content/themes/listingeasy/core/integrations/js/gt3-job-managerb34d.js?ver=1.7.4')}}" id='gt3listing-scripts-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.min6b25.js?ver=2.1.4')}}" id='js-cookie-js'></script>
      <script type='text/javascript' id='woocommerce-js-extra'>
         /* <![CDATA[ */
         var woocommerce_params = {"ajax_url":"\/wp\/md\/listingeasy\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/wp\/md\/listingeasy\/?wc-ajax=%%endpoint%%"};
         /* ]]> */
      </script>
      <script type='text/javascript' src="{{asset('front_assets/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min20fd.js?ver=4.9.2')}}" id='woocommerce-js'></script> -->
    <!--   <script type='text/javascript' id='wc-cart-fragments-js-extra'>
         /* <![CDATA[ */
         var wc_cart_fragments_params = {"ajax_url":"\/wp\/md\/listingeasy\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/wp\/md\/listingeasy\/?wc-ajax=%%endpoint%%","cart_hash_key":"wc_cart_hash_04343303ab860cb28120a403a48f64be","fragment_name":"wc_fragments_04343303ab860cb28120a403a48f64be","request_timeout":"5000"};
         /* ]]> */
      </script> -->
   <!--    <script type='text/javascript' src="{{asset('front_assets/wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min20fd.js?ver=4.9.2')}}" id='wc-cart-fragments-js'></script> -->
   <!--    <script type='text/javascript' id='gt3-extended-location-js-extra'>
         /* <![CDATA[ */
         var gt3_ext_loc = {"start_point":"New York, NY, USA","start_geo_lat":"40.7127753","start_geo_long":"-74.0059728","enable_map":"1","user_location":[],"l10n":{"locked":"Lock Pin","unlocked":"Unlock Pin"}};
         /* ]]> */
      </script> -->
      <script type='text/javascript' src="{{asset('front_assets/wp-content/themes/listingeasy/js/themee5fb.js?ver=1610440284')}}" id='gt3_theme_js-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-content/themes/listingeasy/js/jquery.event.swipee7f0.js?ver=1.3.1')}}" id='jquery-event-swipe-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-content/themes/listingeasy/js/jquery.isotope.mind96d.js?ver=5.6.1')}}" id='gt3_isotope-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-includes/js/imagesloaded.mineda1.js?ver=4.1.4')}}" id='imagesloaded-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-content/plugins/woocommerce/assets/js/select2/select2.full.minfa0c.js?ver=4.0.3')}}" id='select2-js'></script>
      <!-- <script type='text/javascript' src="{{asset('front_assets/wp-content/plugins/wp-job-manager-locations/assets/js/main.minf72a.js?ver=20190128')}}" id='job-regions-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-includes/js/wp-embed.mind96d.js?ver=5.6.1')}}" id='wp-embed-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-content/plugins/js_composer/assets/js/dist/js_composer_front.mine6df.js?ver=6.5.0')}}" id='wpb_composer_front_js-js'></script> -->
      <!-- <script type='text/javascript' src="{{asset('front_assets/wp-content/themes/listingeasy/js/sorting_packeryd96d.js?ver=5.6.1')}}" id='gt3_isotope_sorting_packery-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-content/themes/listingeasy/js/nivod96d.js?ver=5.6.1')}}" id='nivo-js'></script>
      <script type='text/javascript' src="{{asset('front_assets/wp-includes/js/comment-reply.mind96d.js?ver=5.6.1')}}" id='comment-reply-js'></script>
      <script type="text/javascript" id="gt3_custom_footer_js">jQuery(document).ready(function(){
         });
      </script>  -->

      <script type="text/javascript" src="{{asset('front_assets/js/jquery.min.js')}}"></script>
      <script type="text/javascript" src="{{asset('front_assets/js/jquery-migrate-3.0.1.min.js')}}"></script>
      ...
      <script type="text/javascript" src="{{asset('front_assets/js/jquery.waypoints.min.js')}}"></script>
      <script type="text/javascript" src="{{asset('front_assets/js/jquery.stellar.min.js')}}"></script>
      ...
      <script type="text/javascript" src="{{asset('front_assets/js/aos.js')}}"></script>
      <script type="text/javascript" src="{{asset('front_assets/js/jquery.animateNumber.min.js')}}"></script>
      <script type="text/javascript" src="{{asset('front_assets/js/bootstrap-datepicker.js')}}"></script>
      <script type="text/javascript" src="{{asset('front_assets/js/jquery.timepicker.min.html')}}"></script>
      <script type="text/javascript" src="{{asset('front_assets/js/scrollax.min.js')}}"></script>
      <script type="text/javascript" src="{{asset('front_assets/js/google-map.js')}}"></script>
      <script type="text/javascript" src="{{asset('front_assets/js/main.js')}}"></script>
       <script type="text/javascript" src="{{asset('front_assets/js/lightbox-plus-jquery.min.js')}}"></script>
...
@yield('pageScript')
   ...
   <!-- Mirrored from livewp.site/wp/md/listingeasy/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 07:05:01 GMT -->
</html>