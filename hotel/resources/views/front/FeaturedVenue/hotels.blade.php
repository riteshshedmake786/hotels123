        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="main-content">
                    ...
                    <div class="item list" data-map-latitude="{{ $value->lat }}" data-map-longitude="{{ $value->long }}"
                        data-id="{{ $value->id }}">
                        ...
                        <div class="description">
                            ...
                            <!--end meta-->
                            <div class="info">
                                @if(Auth::guard('merchant')->user() || Auth::guard('web')->user())
                                <a href="{{ url('/hotelVenues/'.$value->id) }}">
                                    <h3>{{ $value->name }}</h3>
                                </a>
                                @else
